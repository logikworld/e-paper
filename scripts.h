...
void sendJS_A()
{
server.send(200, F("text/javascript"), 
F("var srcBox,srcImg,dstImg;\r\n"
...
"Btn(6,'lev clock mono','procImgClk(true,false);')+\r\n"
"Btn(6,'lev clock','procImgClk(true,true);')+\r\n"
"Btn(6,'Dith clock mono','procImgClk(false,false);')+\r\n"
"Btn(6,'Dith clock','procImgClk(false,true);')+\r\n"
"Btn(7,'Clock image','clockloadImage();'));\r\n"
...
{
server.send(200, F("text/javascript"),
F("function procImg(isLvl,isRed){\r\n"
...
"}\r\n"
//**********************************************
"function procImgClk(isLvl,isRed){\r\n"
    "var palInd=epdArr[epdInd][2];\r\n"
    ...
    "sW=400;\r\n"
    "sH=300;\r\n"
    "source=getElm('canvas');\r\n"
    "source.width=sW;\r\n"
    "source.height=sH;\r\n"
    "source.getContext('2d').drawImage(clockcanvas,0,0,sW,sH);\r\n"
    "dX=parseInt(getElm('nud_x').value);\r\n"
    "dY=parseInt(getElm('nud_y').value);\r\n"
    "dW=parseInt(getElm('nud_w').value);\r\n"
    "dH=parseInt(getElm('nud_h').value);\r\n"
    ...
    "canvas.height=dH;\r\n"
    "var index=0;\r\n"
    "var pSrc=source.getContext('2d').drawImage(clockcanvas,0,0,sW,sH);\r\n"
    "var pDst=canvas.getContext('2d').getImageData(0,0,dW,dH);\r\n"
...
"}\r\n"
//-------------------------------------------
"function clockloadImage(){\r\n"
    "var c=getElm('clockcanvas');\r\n"
    "var w=dispW=c.width;\r\n"
    "var h=dispH=c.height;\r\n"
    "var p=c.getContext('2d').getImageData(0,0,w,h);\r\n"
    "var a=new Array(w*h);\r\n"
